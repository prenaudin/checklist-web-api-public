class UserCopyChecklistContext
  attr_reader :user, :project, :checklist, :destination_project

  def self.call(user_id, project_id, checklist_id, destination_project_id)
    new(user_id, project_id, checklist_id, destination_project_id).call
  end
