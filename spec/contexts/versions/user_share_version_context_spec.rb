RSpec.describe UserShareVersionContext do
  ...
  it 'returns a version with a public_token' do
    expect do
      ...
      .to change { version.reload.public_token }.from(nil).to be_kind_of(String)
  end
end
